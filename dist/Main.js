...
var _ricardoperez$elm_login_app$Types$Model = F4(
	function (a, b, c, d) {
		return {email: a, password: b, token: c, errorMsg: d};
	});
var _ricardoperez$elm_login_app$Types$GetTokenSuccess = function (a) {
	return {ctor: 'GetTokenSuccess', _0: a};
};
var _ricardoperez$elm_login_app$Types$SetPassword = function (a) {
	return {ctor: 'SetPassword', _0: a};
};
var _ricardoperez$elm_login_app$Types$SetEmail = function (a) {
	return {ctor: 'SetEmail', _0: a};
};
var _ricardoperez$elm_login_app$Types$AuthError = function (a) {
	return {ctor: 'AuthError', _0: a};
};
var _ricardoperez$elm_login_app$Types$HttpError = function (a) {
	return {ctor: 'HttpError', _0: a};
};
var _ricardoperez$elm_login_app$Types$LogOut = {ctor: 'LogOut'};
var _ricardoperez$elm_login_app$Types$ClickLogIn = {ctor: 'ClickLogIn'};

var _ricardoperez$elm_login_app$View$logedBox = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$id('greeting')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						A2(_elm_lang$core$Basics_ops['++'], 'Hello, ', model.email))
					])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('You are logged in!!!')
					])),
				A2(
				_elm_lang$html$Html$p,
				_elm_lang$core$Native_List.fromArray(
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$html$Html_Events$onClick(_ricardoperez$elm_login_app$Types$LogOut)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
...
var _ricardoperez$elm_login_app$View$messageBox = function (model) {
	var hasError = (_elm_lang$core$Native_Utils.cmp(
		_elm_lang$core$String$length(model.errorMsg),
		0) > 0) ? true : false;
	return hasError ? A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
...
var _ricardoperez$elm_login_app$View$loginForm = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('If you already have an account, please Log In.')
					])),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_ricardoperez$elm_login_app$View$messageBox(model)
					])),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
							...
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										...
										_elm_lang$html$Html_Events$onInput(_ricardoperez$elm_login_app$Types$SetEmail)
									]),
								_elm_lang$core$Native_List.fromArray(
									[]))
							]))
							...
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										...
										_elm_lang$html$Html_Events$onInput(_ricardoperez$elm_login_app$Types$SetPassword)
									]),
								_elm_lang$core$Native_List.fromArray(
									[]))
							]))
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$html$Html_Events$onClick(_ricardoperez$elm_login_app$Types$ClickLogIn)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Log In')
...
var _ricardoperez$elm_login_app$View$loginBox = function (model) {
	var loggedIn = (_elm_lang$core$Native_Utils.cmp(
		_elm_lang$core$String$length(model.token),
		0) > 0) ? true : false;
	return loggedIn ? _ricardoperez$elm_login_app$View$logedBox(model) : _ricardoperez$elm_login_app$View$loginForm(model);
};
var _ricardoperez$elm_login_app$View$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[
				_ricardoperez$elm_login_app$View$loginBox(model)
			]));
};

var _ricardoperez$elm_login_app$Main$handlingBadResponse = function (status) {
	var _p0 = status;
	switch (_p0) {
		case 401:
		...
		default:
			return 'Some Uncaught Error';
	}
};
var _ricardoperez$elm_login_app$Main$handlingError = function (err) {
	var _p1 = err;
	switch (_p1.ctor) {
		case 'Timeout':
			return 'Error Accessing the Login, try again latter';
		case 'NetworkError':
			return 'Error Accessing the Login, try again latter';
		case 'UnexpectedPayload':
			return 'Wrong params';
		default:
			return _ricardoperez$elm_login_app$Main$handlingBadResponse(_p1._0);
	}
};
var _ricardoperez$elm_login_app$Main$tokenDecoder = A2(_elm_lang$core$Json_Decode_ops[':='], 'token', _elm_lang$core$Json_Decode$string);
var _ricardoperez$elm_login_app$Main$authBody = function (model) {
	return _evancz$elm_http$Http$multipart(
		_elm_lang$core$Native_List.fromArray(
			[
				A2(_evancz$elm_http$Http$stringData, 'email', model.email),
				A2(_evancz$elm_http$Http$stringData, 'password', model.password)
			]));
};
var _ricardoperez$elm_login_app$Main$authUser = F2(
	function (model, apiUrl) {
		return A3(
			_evancz$elm_http$Http$post,
			_ricardoperez$elm_login_app$Main$tokenDecoder,
			apiUrl,
			_ricardoperez$elm_login_app$Main$authBody(model));
	});
var _ricardoperez$elm_login_app$Main$authUserCmd = F2(
	function (model, apiUrl) {
		return A3(
			_elm_lang$core$Task$perform,
			_ricardoperez$elm_login_app$Types$AuthError,
			_ricardoperez$elm_login_app$Types$GetTokenSuccess,
			A2(_ricardoperez$elm_login_app$Main$authUser, model, apiUrl));
	});
var _ricardoperez$elm_login_app$Main$hostUrl = 'http://authost.com/';
var _ricardoperez$elm_login_app$Main$authUrl = A2(_elm_lang$core$Basics_ops['++'], _ricardoperez$elm_login_app$Main$hostUrl, 'auth');
var _ricardoperez$elm_login_app$Main$init = function (model) {
	return {
		ctor: '_Tuple2',
		_0: A4(_ricardoperez$elm_login_app$Types$Model, '', '', '', ''),
		_1: _elm_lang$core$Platform_Cmd$none
	};
};
var _ricardoperez$elm_login_app$Main$setStorage = _elm_lang$core$Native_Platform.outgoingPort(
	'setStorage',
	function (v) {
		return {email: v.email, password: v.password, token: v.token, errorMsg: v.errorMsg};
	});
var _ricardoperez$elm_login_app$Main$setStorageHelper = function (model) {
	return {
		ctor: '_Tuple2',
		_0: model,
		_1: _ricardoperez$elm_login_app$Main$setStorage(model)
	};
};
var _ricardoperez$elm_login_app$Main$update = F2(
	function (msg, model) {
		var _p2 = msg;
		switch (_p2.ctor) {
			case 'ClickLogIn':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: A2(_ricardoperez$elm_login_app$Main$authUserCmd, model, _ricardoperez$elm_login_app$Main$authUrl)
				};
			case 'HttpError':
			...
			case 'AuthError':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							errorMsg: _ricardoperez$elm_login_app$Main$handlingError(_p2._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'SetEmail':
			...
			case 'GetTokenSuccess':
				return _ricardoperez$elm_login_app$Main$setStorageHelper(
					_elm_lang$core$Native_Utils.update(
						model,
						{token: _p2._0, password: '', errorMsg: ''}));
			default:
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
...
var _ricardoperez$elm_login_app$Main$main = {
	main: _elm_lang$html$Html_App$programWithFlags(
		{
			init: _ricardoperez$elm_login_app$Main$init,
			update: _ricardoperez$elm_login_app$Main$update,
			subscriptions: function (_p3) {
				return _elm_lang$core$Platform_Sub$none;
			},
			view: _ricardoperez$elm_login_app$View$view
		}),
			...
			[
				...
				A2(
					...
					function (email) {
						return A2(
							_elm_lang$core$Json_Decode$andThen,
							A2(_elm_lang$core$Json_Decode_ops[':='], 'errorMsg', _elm_lang$core$Json_Decode$string),
							function (errorMsg) {
								return A2(
									_elm_lang$core$Json_Decode$andThen,
										...
										return A2(
											...
											function (token) {
												return _elm_lang$core$Json_Decode$succeed(
													{email: email, errorMsg: errorMsg, password: password, token: token});
											});
									});
							});
					}))
...
var _ricardoperez$elm_login_app$Main$removeStorage = _elm_lang$core$Native_Platform.outgoingPort(
	'removeStorage',
	function (v) {
		return {email: v.email, password: v.password, token: v.token, errorMsg: v.errorMsg};
	});
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _ricardoperez$elm_login_app$Main$main === 'undefined' ? null : _ricardoperez$elm_login_app$Main$main);
